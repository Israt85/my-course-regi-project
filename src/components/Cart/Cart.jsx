...
const Cart = ({cart,totalHr,remaining }) => {
    return (
        <div className="w-3/4 p-4">
            <h3 className=" py-6 border-b-2 text-blue-600 font-medium text-xl">Credit Hour Remaining:{remaining} </h3>
            <h2 className="text-2xl font-semibold border-b-2 py-6">Course name: {cart.length}</h2>
           {
             ...
             <p className="text-xl font-medium py-4">Total Credit Hour :{totalHr} </p>
        </div>
    );
};
