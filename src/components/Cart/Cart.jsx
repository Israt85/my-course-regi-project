...
const Cart = ({cart,totalHr,remaining }) => {
    return (
        <div className="w-3/4 bg-gray-100 h-full rounded-2xl px-2 py-4">
            <h3 className=" bg-slate-300 px-2 rounded-xl py-6 border-b-2 text-blue-600 font-medium text-xl">Credit Hour Remaining: {remaining} hr </h3>
